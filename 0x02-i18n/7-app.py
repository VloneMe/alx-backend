...
It also infers the appropriate timezone
for the user based on the URL parameter or
the user's data. If the specified locale is
available in the supported languages, it will be used;
otherwise, the best match locale
will be determined based on the Accept-Language header.
Similarly, if the specified timezone
